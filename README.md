...
- **Formula:**  
  ![](https://latex.codecogs.com/svg.image?\dpi{200}\pagecolor{white}%20u_{n+1}%20=%20u_n%20+%20\text{incrementBetweenModuleIds}%20)

- **Initial Term:**  
  ![](https://latex.codecogs.com/svg.image?\dpi{200}\pagecolor{white}%20u_1%20=%20\text{firstModuleId})

- **Range:**  
  ![](https://latex.codecogs.com/svg.image?\dpi{200}\pagecolor{white}%20n%20\in%20[1,%20\text{numberOfModules}])
